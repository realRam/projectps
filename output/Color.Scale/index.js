...
var sample = function (v) {
    return function (x) {
                ...
                return function ($copy_v2) {
                    return function ($copy_v3) {
                        ...
                        function $tco_loop(v1, v2, v3) {
                            ...
                            throw new Error("Failed pattern match at Color.Scale line 91, column 5 - line 91, column 23: " + [ v1.constructor.name, v2.constructor.name, v3.constructor.name ]);
                        };
                        while (!$tco_done) {
        ...
        throw new Error("Failed pattern match at Color.Scale line 85, column 1 - line 85, column 40: " + [ v.constructor.name, x.constructor.name ]);
    };
};
