...
var toXYZ = function (c) {
    ...
    var finv = function (c$prime) {
        ...
        throw new Error("Failed pattern match at Color line 325, column 5 - line 328, column 1: " + [ c$prime.constructor.name ]);
    };
    var g = finv(rec.g);
    var r = finv(rec.r);
    var b = finv(rec.b);
    ...
    return function (y) {
        return function (z) {
            var f = function (c) {
                ...
                throw new Error("Failed pattern match at Color line 195, column 5 - line 198, column 1: " + [ c.constructor.name ]);
            };
...
var luminance = function (col) {
    ...
    var f = function (c) {
        ...
        throw new Error("Failed pattern match at Color line 526, column 9 - line 529, column 9: " + [ c.constructor.name ]);
    };
    var g = f(val.g);
    var r = f(val.r);
    var b = f(val.b);
    ...
    return function (a) {
        return function (b) {
            ...
            var finv = function (t) {
                ...
                throw new Error("Failed pattern match at Color line 220, column 5 - line 221, column 64: " + [ t.constructor.name ]);
            };
...
var toLab = function (col) {
    ...
    var f = function (t) {
        ...
        throw new Error("Failed pattern match at Color line 343, column 5 - line 346, column 1: " + [ t.constructor.name ]);
    };
    ...
    return function (c1) {
        return function (c2) {
            return function (frac) {
                ...
                throw new Error("Failed pattern match at Color line 474, column 1 - line 474, column 55: " + [ v.constructor.name, c1.constructor.name, c2.constructor.name, frac.constructor.name ]);
            };
        };
    };
};
...
var textColor = function (c) {
    ...
    throw new Error("Failed pattern match at Color line 565, column 1 - line 565, column 28: " + [ c.constructor.name ]);
};
module.exports = {
    RGB: RGB, 
    HSL: HSL, 
